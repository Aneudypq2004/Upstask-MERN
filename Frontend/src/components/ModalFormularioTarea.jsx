                                ...
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    <form className='my-10' onSubmit={handleSubmit}>
                                        ...
                                        <div className='mb-5'>
                                            ...
                                            >
                                                <option disabled className='uppercase'>--Seleccione--</option>
                                                <option className='uppercase' value={'Baja'}>Baja</option>
                                                <option className='uppercase' value={'Media'}>Media</option>
                                                <option className='uppercase' value={'Alta'}>Alta</option>
